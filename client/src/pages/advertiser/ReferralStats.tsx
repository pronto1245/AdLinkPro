              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>• Новый пользователь регистрируется по ссылке</li>
                    <li>• Вы получаете 5% с каждой его выплаты</li>
                    <li>• Комиссия начисляется автоматически</li>
                  </ul>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>• Комиссия: 5% с доходов реферала</li>
                    <li>• Минимальная выплата: $50</li>
                    <li>• Выплаты: ежемесячно</li>
              ...
              <div className="border-t pt-4">
                <div className="bg-blue-50 dark:bg-blue-950 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    Приглашайте активных партнеров, которые планируют работать долгосрочно. 
                    Ваша комиссия будет расти вместе с их доходами!
                  </p>
                </div>
              </div>
            </CardContent>
