export const translations = {
  en: {
    ...
    'geo_placeholder': 'US, GB, DE',
    'custom_app_placeholder': 'Enter your app',
    'pwa_apps': 'PWA apps',
    'webview_apps': 'WebView apps',
    'android_apps': 'Android apps (.apk)',
    'ios_apps': 'iOS apps',
    ...
    'traffic_sources_not_specified': 'Traffic sources not specified',
    'allowed_applications': 'Allowed Applications',
    'allowed_apps_not_specified': 'Allowed applications not specified',
  ...
  ru: {
    ...
    'url_placeholder': 'https://example.com',
    'geo_placeholder': 'US, GB, DE',
    'custom_app_placeholder': 'Введите своё приложение',
    'pwa_apps': 'PWA приложения',
    'webview_apps': 'WebView приложения',
    'android_apps': 'Android приложения (.apk)',
    'ios_apps': 'iOS приложения',
    'mobile_apps': 'Мобильные приложения',
    'desktop_apps': 'Настольные приложения',
    'web_apps': 'Веб приложения',
    'telegram_bots': 'Telegram боты',
    'browser_extensions': 'Браузерные расширения',
    'chrome_extensions': 'Расширения Chrome',
    'firefox_extensions': 'Расширения Firefox',
    'additional_info': 'Дополнительно',
    'vertical': 'Вертикаль',
    'traffic_sources': 'Источники трафика',
    'traffic_sources_not_specified': 'Источники трафика не указаны',
    'allowed_applications': 'Разрешенные приложения',
    'allowed_apps_not_specified': 'Разрешенные приложения не указаны',
    'kpi_description': 'Описание KPI',
    'type': 'Тип',
