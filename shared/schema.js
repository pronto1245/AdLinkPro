...
import { pgTable, pgEnum, text, varchar, uuid, decimal, integer, boolean, timestamp, jsonb, index, serial, bigint, numeric, char, smallint } from 'drizzle-orm/pg-core';
...
*/
export const postbackDeliveries = {};
