...
import { pgTable, text, uuid, varchar, decimal, timestamp, boolean, jsonb, integer, pgEnum, index, serial, bigint } from "drizzle-orm/pg-core";
...
// trackingClicks moved to tracking-schema.ts to eliminate duplication
...
// postbackProfiles moved to postback-schema.ts to eliminate duplication

// postbackDeliveries moved to postback-schema.ts to eliminate duplication
...
// Types moved to respective schema files
// PostbackProfile and related types moved to postback-schema.ts
// TrackingClick and related types moved to tracking-schema.ts
