...
- ✅ Реализована кликабельная навигация по офферам:
  ...
  * Ctrl+Клик по названию открывает детали в новой вкладке
  * Добавлена отдельная кнопка "открыть в новой вкладке" в столбец действий
  * URL-параметр автоматически открывает нужный оффер при загрузке страницы
