...
1. **Frontend интерфейс** - обновить TeamManagement.tsx для отображения новых участников
2. **Авторизация участников** - настроить логин для team members
3. **Ограничения интерфейса** - применить permissions в UI компонентах
4. **Статистика команды** - добавить аналитику по SubID префиксам