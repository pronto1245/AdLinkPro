...
export const config = {
  ...
  // BI Systems integration (опционально)
  LOOKER_ENDPOINT: getEnvVar('LOOKER_ENDPOINT'),
  LOOKER_API_KEY: getEnvVar('LOOKER_API_KEY'),
  LOOKER_CLIENT_ID: getEnvVar('LOOKER_CLIENT_ID'),
  LOOKER_CLIENT_SECRET: getEnvVar('LOOKER_CLIENT_SECRET'),
  
  METABASE_ENDPOINT: getEnvVar('METABASE_ENDPOINT'),
  METABASE_API_KEY: getEnvVar('METABASE_API_KEY'),
  METABASE_USERNAME: getEnvVar('METABASE_USERNAME'),
  METABASE_PASSWORD: getEnvVar('METABASE_PASSWORD'),
  
  POWERBI_ENDPOINT: getEnvVar('POWERBI_ENDPOINT'),
  POWERBI_API_KEY: getEnvVar('POWERBI_API_KEY'),
  POWERBI_TENANT_ID: getEnvVar('POWERBI_TENANT_ID'),
  POWERBI_CLIENT_ID: getEnvVar('POWERBI_CLIENT_ID'),
  POWERBI_CLIENT_SECRET: getEnvVar('POWERBI_CLIENT_SECRET'),
...
export function validateConfig(): void {
  ...
  [
    ...
    'LOOKER_ENDPOINT','LOOKER_API_KEY','METABASE_ENDPOINT','METABASE_API_KEY',
    'POWERBI_ENDPOINT','POWERBI_API_KEY','POWERBI_TENANT_ID'
  ].forEach(k => { 
